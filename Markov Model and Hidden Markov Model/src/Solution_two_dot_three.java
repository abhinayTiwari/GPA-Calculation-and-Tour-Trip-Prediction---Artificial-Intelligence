...
public class Solution_two_dot_three {
  ...
  public static double normalDistribution(double mean, double standardDeviation,int data){
	...
	public static void main(String[] args) {
		...
		System.out.println("Sequence of four Cities that has largest probability based on HMM is  "+ArrayUtils.toString(citiesHavingLargestProbability));
