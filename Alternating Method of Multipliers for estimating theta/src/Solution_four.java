...
public class Solution_four {
	...
	public static Matrix minimizeGradientDescent(Matrix Gamma, Matrix Beta, double rho){
		...
		for(int i=0;i<gd_maxIter;i++){
			...
			for(int j=0; j< 10; j++){
				...
				gradientOfFirstPart = gradientOfFirstPart.plus(featureValuesInMatrix.times(bracketValue));			
			}
	...
	public static Matrix minimizeGradientDescent1(Matrix Gamma, Matrix Beta, double rho){
		int r = 3;
		int c = 1;
		Matrix Theta = new Matrix(r,c); 
		double[][] feature = {{1,3.8,10}, {1,3.5,4}, {1,3.0,2}, {1,3.2,5}, {1,2.7,8}, {1,2.0,3},{1,2.5,10},{1,3.6,8},{1,1.75,2},{1,3.35,9}};
	...
	public static void main(String[] args) {
		Matrix Theta = admm();
		System.out.println("The estimated theta by ADMM: ");
