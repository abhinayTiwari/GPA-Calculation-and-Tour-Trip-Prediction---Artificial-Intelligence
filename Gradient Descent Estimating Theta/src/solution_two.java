...
public class solution_two {
	...
	public static Matrix linear_gradient_descent(){
		...
		for(int i=0;i<gd_maxIter;i++){
			...
			for(int j=0; j< 10; j++){
				...
				Gradient = Gradient.plus(featureValuesInMatrix.times(2.0).times(bracketValue).plus(l2normalizationVariable));
			}
	...
	public static void calculateGPA(Matrix Theta){
			...
			double[] predictedGPA = new double[maxExample] ;
	 		...
	 		System.out.println("Predicted GPA using linear  regression with l2 normalization: \n"+ArrayUtils.toString(predictedGPA));
	...
	public solution_two(){
		...
		public static void main(String[] args) {
			...
			System.out.println("The estimated theta by linear l2 norm gradient descent: \n");
